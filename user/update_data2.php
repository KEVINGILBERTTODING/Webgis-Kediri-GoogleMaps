    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800"><b>Update Data Peternakan Sapi</b></h1>
          <!-- Basic Card Example -->
            ...
            <div class="card-body">
              <form class="user" action="update_data2.php?id=<?= $contact['id'] ?>" method="post">
                <div class="form-group">
                  <input type="text" class="form-control form-control" value="<?= $contact['id'] ?>" id="id" placeholder="ID" name="id" readonly>
                </div>
                <div class="form-group">
