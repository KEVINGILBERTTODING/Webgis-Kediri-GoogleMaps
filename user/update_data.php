          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <form class="user" action="update_data.php?id=<?= $contact['id'] ?>" method="post">
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control" id="kodedagri" value="<?= $contact['kodedagri'] ?>" placeholder="Kodedagri" name="kodedagri" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <input type="number" class="form-control form-control" value="<?= $contact['jml'] ?>" id="jml" placeholder="Jumlah" name="jml" required>
                </div>
